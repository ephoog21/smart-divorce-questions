          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="prose prose-lg max-w-none">
              ...
              <section className="mb-12">
                <h2 className="font-serif text-3xl font-semibold text-navy-900 mb-6">Community Property vs. Equitable Distribution</h2>
                
                <div className="grid md:grid-cols-2 gap-6 mb-8">
                  <div className="bg-white border border-stone-200 rounded-lg shadow-sm p-6">
                    <h3 className="text-xl font-semibold text-teal-900 mb-4">Community Property States</h3>
                    <p className="text-teal-800 mb-4">50/50 split of marital property</p>
                  ...
                  <div className="bg-white border border-stone-200 rounded-lg shadow-sm p-6">
                    <h3 className="text-xl font-semibold text-navy-900 mb-4">Equitable Distribution</h3>
                    <p className="text-navy-800 mb-4">Fair, but not necessarily equal split</p>
                    <div className="text-sm text-slate-700">
              ...
              <section className="mb-12">
                <h2 className="font-serif text-3xl font-semibold text-navy-900 mb-6">Major Assets to Divide</h2>
                
                <div className="space-y-6">
                  <div className="bg-white border border-stone-200 rounded-lg shadow-sm p-6">
                    <h3 className="text-2xl font-semibold text-teal-600 mb-4">Family Home</h3>
                    <p className="text-slate-700 mb-4">Often the largest marital asset</p>
                    <div className="grid md:grid-cols-3 gap-4">
                      <div className="bg-teal-50 border border-teal-200 p-4 rounded">
                        <h4 className="font-semibold mb-2">Sell and Split</h4>
                        <p className="text-sm text-slate-700">Clean break, split proceeds</p>
                      </div>
                      <div className="bg-teal-50 border border-teal-200 p-4 rounded">
                        <h4 className="font-semibold mb-2">Buyout</h4>
                        <p className="text-sm text-slate-700">One spouse keeps, pays other half of equity</p>
                      </div>
                      <div className="bg-teal-50 border border-teal-200 p-4 rounded">
                        <h4 className="font-semibold mb-2">Co-ownership</h4>
                        <p className="text-sm text-slate-700">Continue owning together (rare)</p>
                      </div>
                    </div>
                  </div>

                  <div className="bg-white border border-stone-200 rounded-lg shadow-sm p-6">
                    <h3 className="text-2xl font-semibold text-teal-600 mb-4">Retirement Accounts</h3>
                    <p className="text-slate-700 mb-4">401(k)s, IRAs, pensions accumulated during marriage</p>
                    <div className="bg-teal-50 border border-teal-200 p-4 rounded">
                      <h4 className="font-semibold mb-2">QDRO Required</h4>
                      <p className="text-sm text-slate-700">Qualified Domestic Relations Order allows penalty-free transfer between spouses</p>
                    </div>
                  </div>

                  <div className="bg-white border border-stone-200 rounded-lg shadow-sm p-6">
                    <h3 className="text-2xl font-semibold text-teal-600 mb-4">Business Assets</h3>
                    <p className="text-slate-700 mb-4">Businesses started or grown during marriage</p>
                    <div className="grid md:grid-cols-2 gap-4">
                      <div className="bg-teal-50 border border-teal-200 p-4 rounded">
                        <h4 className="font-semibold mb-2">Valuation Required</h4>
                        <p className="text-sm text-slate-700">Professional appraisal needed</p>
                      </div>
                      <div className="bg-teal-50 border border-teal-200 p-4 rounded">
                        <h4 className="font-semibold mb-2">Options</h4>
                        <p className="text-sm text-slate-700">Sell, buyout, or co-own</p>
                      </div>
                    </div>
                  </div>

                  <div className="bg-white border border-stone-200 rounded-lg shadow-sm p-6">
                    <h3 className="text-2xl font-semibold text-navy-600 mb-4">Debt Division</h3>
                    <p className="text-slate-700 mb-4">Joint debts and credit cards</p>
                    <div className="bg-teal-50 border border-teal-200 p-4 rounded">
                      <h4 className="font-semibold mb-2 text-navy-600">Important:</h4>
                      <p className="text-sm text-slate-700">Creditors can still hold both spouses responsible regardless of divorce agreement</p>
                    </div>
                  </div>
                </div>
              </section>
              ...
              <div className="bg-teal-50 border border-teal-200 p-8 rounded-lg mt-12">
                <h3 className="font-serif text-2xl font-semibold text-teal-900 mb-4">Tips for Asset Division</h3>
              ...
              <div className="mt-16 pt-8 border-t border-gray-200">
                <p className="text-xs text-gray-500 text-center">
                  ...
                  Every situation is unique. Please consult with qualified legal and financial professionals for advice specific to your circumstances. 
