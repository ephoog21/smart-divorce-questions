...
export default function Home() {
  return (
    <>
      {/* Hero Section */}
      <section className="relative bg-gradient-to-br from-navy-800 via-navy-700 to-teal-800 text-white py-16 px-6 sm:px-12 md:py-28">
        <div className="absolute inset-0 bg-black/20"></div>
        <div className="relative container mx-auto text-center">
          <h1 className="font-serif text-4xl sm:text-5xl lg:text-6xl font-bold mb-6 text-white leading-tight drop-shadow-sm">
            Smart Divorce Questions
          </h1>
          <p className="text-xl sm:text-2xl text-slate-100 max-w-4xl mx-auto leading-relaxed mb-10 drop-shadow-sm">
