          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="prose prose-lg max-w-none">
              ...
              <section className="mb-12">
                <h2 className="font-serif text-3xl font-semibold text-navy-900 mb-6">Fee Structures</h2>
                
                <div className="grid md:grid-cols-3 gap-6 mb-8">
                  <div className="bg-white border border-stone-200 rounded-lg shadow-sm p-6">
                    <h3 className="text-xl font-semibold text-teal-900 mb-4">Hourly Rate</h3>
                    <p className="text-teal-800 text-2xl font-bold mb-2">$200-$500/hr</p>
                  ...
                  <div className="bg-white border border-stone-200 rounded-lg shadow-sm p-6">
                    <h3 className="text-xl font-semibold text-teal-900 mb-4">Flat Fee</h3>
                    <p className="text-teal-800 text-2xl font-bold mb-2">$1,000-$5,000</p>
                    <ul className="text-sm text-slate-700 space-y-1">
                  ...
                  <div className="bg-white border border-stone-200 rounded-lg shadow-sm p-6">
                    <h3 className="text-xl font-semibold text-navy-900 mb-4">Mediation</h3>
                    <p className="text-navy-800 text-2xl font-bold mb-2">$100-$300/hr</p>
                    <ul className="text-sm text-slate-700 space-y-1">
              ...
              <section className="mb-12">
                <h2 className="font-serif text-3xl font-semibold text-navy-900 mb-6">Questions to Ask About Fees</h2>
              ...
              <section className="mb-12">
                <h2 className="font-serif text-3xl font-semibold text-navy-900 mb-6">What Affects the Cost?</h2>
                
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    <h3 className="text-xl font-semibold text-navy-600 mb-3">Increases Cost</h3>
                  ...
                  <div>
                    <h3 className="text-xl font-semibold text-teal-600 mb-3">Reduces Cost</h3>
                    <ul className="space-y-2 text-slate-700">
              ...
              <section className="mb-12">
                <h2 className="font-serif text-3xl font-semibold text-navy-900 mb-6">Additional Costs to Consider</h2>
                
                <div className="overflow-x-auto">
                  <table className="min-w-full bg-white border border-stone-200 rounded-lg shadow-sm">
                    <thead className="bg-teal-50">
                      <tr>
                        <th className="px-6 py-3 text-left text-xs font-medium text-slate-600 uppercase tracking-wider">Service</th>
                        <th className="px-6 py-3 text-left text-xs font-medium text-slate-600 uppercase tracking-wider">Typical Cost</th>
                        <th className="px-6 py-3 text-left text-xs font-medium text-slate-600 uppercase tracking-wider">When Needed</th>
                      </tr>
                    </thead>
                    <tbody className="divide-y divide-stone-200">
                      <tr>
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-slate-900">Court Filing Fees</td>
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-slate-600">$100-$400</td>
                        <td className="px-6 py-4 text-sm text-slate-600">All divorces</td>
                      </tr>
                      <tr>
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-slate-900">Business Valuation</td>
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-slate-600">$5,000-$15,000</td>
                        <td className="px-6 py-4 text-sm text-slate-600">Business owners</td>
                      </tr>
                      <tr>
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-slate-900">Home Appraisal</td>
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-slate-600">$300-$600</td>
                        <td className="px-6 py-4 text-sm text-slate-600">Property division</td>
                      </tr>
                      <tr>
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-slate-900">Forensic Accountant</td>
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-slate-600">$300-$500/hr</td>
                        <td className="px-6 py-4 text-sm text-slate-600">Hidden assets suspected</td>
                      </tr>
                      <tr>
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-slate-900">Child Custody Evaluation</td>
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-slate-600">$2,000-$8,000</td>
                        <td className="px-6 py-4 text-sm text-slate-600">Contested custody</td>
                      </tr>
                    </tbody>
                  </table>
                </div>
              ...
              <div className="bg-teal-50 border border-teal-200 p-8 rounded-lg mt-12">
                <h3 className="font-serif text-2xl font-semibold text-teal-900 mb-4">Ways to Control Costs</h3>
